...
object ValidationService {
  ...
  val userCondition: ListRequirements[User] = List(
    ...
    ((user: User) => """^([AZERTYUIOPQSDFGHJKLMWXCVBN][azertyuiopqsdfghjklmwxcvbn]*(-[AZERTYUIOPQSDFGHJKLMWXCVBN][azertyuiopqsdfghjklmwxcvbn]*)*\s*)+$""".r matches user.lastName, "The user's last name should only contain letter or dash."),
